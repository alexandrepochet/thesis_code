...
def main(): 
     ...
     market_returns = data.get_return()[(history-length):]
     ...
     RNN_NA_curve = currency.eqCurves['Strategy']
     ...
     plt.savefig(location + 'RNN_LOCF_NA' + '.jpg', pad_inches=1)
     plt.close()
     pdb.set_trace()
